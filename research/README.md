...
Notes gathered while working out how to build this boat — options considered, what other
builders did, and what I decided. Raw material for the [build log](../build_log/README.md);
not yet edited for final copy.
